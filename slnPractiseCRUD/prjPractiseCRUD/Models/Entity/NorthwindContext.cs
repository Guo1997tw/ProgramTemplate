...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<Ectable> Ectables { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-LOUR863;Initial Catalog=Northwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Ectable>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ECTable__3213E83F0BF9C542");

            entity.ToTable("ECTable");
